...
const LINKS = [
  ...
  { href: sportsPath.demo, label: "Sports demo" },
    ...
    <footer className="mt-16 border-t border-line">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-5 py-8 text-sm leading-6 text-ink-soft">
        <p>
          ...
          and not affiliated with any league or sportsbook. The live Sports board uses verified public cards
          and free finals. Sample clubs on the demo ledger are invented. 18+.
        </p>
        <CharoofNav />
